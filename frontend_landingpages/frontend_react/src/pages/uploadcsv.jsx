...
console.log("UploadCSV component file loaded"); // Log for debugging and verifying that the component loads correctly.
...
export function UploadCSV({ onBack }) {
  ...
  const handleFileUpload = async (event) => {
    ...
    try {
      ...
      // 🔴 Red error dialog popup
      setModalType("error");
      setModalMessage(
        "Upload failed. Please check that the Question Text / Course Code is different from the existing question."
      );
      setModalOpen(true);
    }
  };
        ...
        {metadata && (
          <Card className="mt-4 border-blue-400 w-full text-center">
            <CardHeader>
              ...
              <CardDescription>Ensure metadata is correct.</CardDescription>
            </CardHeader>
          ...
          <div style={{ marginTop: "24px" }}>
            <Button
              ...
              style={{
                ...
                color: modalType === "success" ? "#166534" : "#991b1b",
                border: `1px solid ${modalType === "success" ? "#166534" : "#991b1b"}`,
                borderRadius: "8px",
                padding: "8px 16px",
                cursor: "pointer",
              }}
