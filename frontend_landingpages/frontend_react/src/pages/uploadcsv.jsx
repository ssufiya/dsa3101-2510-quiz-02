          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select value={assessmentType} onValueChange={setAssessmentType}>
                ...
                <SelectContent className="bg-white/100 shadow-lg border border-gray-200">
                  <SelectItem value="Final" className="hover:bg-gray-100">Final</SelectItem>
                  <SelectItem value="Midterm" className="hover:bg-gray-100">Midterm</SelectItem>
                  <SelectItem value="Quiz" className="hover:bg-gray-100">Quiz</SelectItem>
                  <SelectItem value="Assignment" className="hover:bg-gray-100">Assignment</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div>
            ...
            <div>
              ...
              <Select value={assessmentSemester} onValueChange={setAssessmentSemester}>
                ...
                <SelectContent className="bg-white/100 shadow-lg border border-gray-200">
                  <SelectItem value="Semester 1" className="hover:bg-gray-100">Semester 1</SelectItem>
                  <SelectItem value="Semester 2" className="hover:bg-gray-100">Semester 2</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </CardContent>
              ...
              {uploadedContexts.map((c, i) => (
                <div key={c.id} className="border p-3 rounded bg-white">
                  <div className="flex justify-between">
                    ...
                    <Button variant="ghost" onClick={() => removeContext(c.id)}>
                      <Trash2 className="h-4 w-4 text-red-600" />
                    </Button>
                  </div>
                </div>
